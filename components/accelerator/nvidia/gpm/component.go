...
//   - [apiv1.HealthStateTypeHealthy] when all GPUs' GPM metrics are successfully retrieved
//
// Suggested Actions:
// This component does not set the [apiv1.HealthState.SuggestedActions] field.
// GPM metrics are collected for performance monitoring and do not require repair actions.
package gpm

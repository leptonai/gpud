...
// on GPU Operator-managed clusters (e.g. with GPU Operator 26.3.2): binary absent from
...
func checkFMActive() bool {
	...
	// listen on port 6666 on the host (LEP-6440, verified on GPU Operator clusters:

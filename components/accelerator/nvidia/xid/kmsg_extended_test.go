...
func TestMatchNVLinkExamples(t *testing.T) {
	tests := []struct {
		...
		{"Log22 SAW_MVB", "NVRM: Xid (PCI:0000:04:00): 144, SAW_MVB Nonfatal XC0 i0 Link 00 (0x00000003 0x80000000 0x00000000 0x00000000)", 0, "SAW_MVB", apiv1.EventTypeFatal, []apiv1.RepairActionType{apiv1.RepairActionTypeIgnoreNoActionRequired, apiv1.RepairActionTypeRebootSystem}},
		{"Log23 SAW_EGR", "NVRM: Xid (PCI:0000:04:00): 144, SAW_EGR Nonfatal XC0 i0 Link 00 (0x00000004 0x00000001 0x00000000 0x00000000)", 0, "SAW_EGR", apiv1.EventTypeFatal, []apiv1.RepairActionType{apiv1.RepairActionTypeIgnoreNoActionRequired, apiv1.RepairActionTypeRebootSystem}},
	}

...
func (c *XIDComponent) HealthStates(_ context.Context) (apiv1.HealthStates, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
	return apiv1.HealthStates{c.currState}, nil
}

func (c *XIDComponent) Events(ctx context.Context, since time.Time) (apiv1.Events, error) {

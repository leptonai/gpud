...
type Temperature struct {
	...
	// NearestSlowdownThresholdMarginCelsius is the thermal headroom (in °C) to the nearest
	...
	NearestSlowdownThresholdMarginCelsius int32 `json:"margin_celsius"`

	// NearestSlowdownThresholdMarginSupported indicates whether NVML provided a margin temperature reading.
	NearestSlowdownThresholdMarginSupported bool `json:"margin_temperature_supported"`
...
func GetTemperature(uuid string, dev device.Device) (Temperature, error) {
	...
	if ret == nvml.SUCCESS {
		temp.NearestSlowdownThresholdMarginCelsius = margin.MarginTemperature

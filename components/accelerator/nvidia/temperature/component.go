...
import (
	...
	nvidia_query_metrics_temperature "github.com/leptonai/gpud/components/accelerator/nvidia/query/metrics/temperature"
...
func (c *component) RegisterCollectors(reg *prometheus.Registry, db *sql.DB, tableName string) error {
	c.gatherer = reg
	return nvidia_query_metrics_temperature.Register(reg, db, tableName)
}

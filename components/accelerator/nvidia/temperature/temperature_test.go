...
func TestGetTemperature(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedTemperature: Temperature{
				...
				NearestSlowdownThresholdMarginCelsius:   12,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.Equal(t, tt.expectedTemperature.NearestSlowdownThresholdMarginCelsius, temperature.NearestSlowdownThresholdMarginCelsius)
			assert.Equal(t, tt.expectedTemperature.NearestSlowdownThresholdMarginSupported, temperature.NearestSlowdownThresholdMarginSupported)

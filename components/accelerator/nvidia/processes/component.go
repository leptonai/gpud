...
//   - [apiv1.HealthStateTypeUnhealthy] when there's an error getting processes from any GPU
//   - [apiv1.HealthStateTypeHealthy] when all GPUs' process information is successfully retrieved
//
// Suggested Actions:
// This component does not set the [apiv1.HealthState.SuggestedActions] field.
// Process information is collected for monitoring purposes only.
package processes

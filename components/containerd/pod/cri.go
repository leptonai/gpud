...
func listAllSandboxes(
	ctx context.Context,
	endpoint string,
	listPodSandboxFunc func(context.Context, runtimeapi.RuntimeServiceClient) (*runtimeapi.ListPodSandboxResponse, error),
	listContainersFunc func(context.Context, runtimeapi.RuntimeServiceClient) (*runtimeapi.ListContainersResponse, error),
) ([]PodSandbox, error) {
	...
	listPodSandboxResp, err := listPodSandboxFunc(ctx, client)
	if err != nil {
		return nil, err
	}

	listContainersResp, err := listContainersFunc(ctx, client)
	if err != nil {
		return nil, err
	}

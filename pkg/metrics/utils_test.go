...
func Test_registerHealthStateMetrics(t *testing.T) {
	...
	setter, err := RegisterHealthStateMetricsWithRegistere(registry, componentName)
	require.NoError(t, err)
	require.NotNil(t, setter)

	// Test setter functionality
	setter.SetHealthy(true)
	setter.SetUnhealthy(false)
	setter.SetDegraded(false)

	// Call the setters multiple times to verify they work
	setter.SetHealthy(false)
	setter.SetUnhealthy(true)
	setter.SetDegraded(true)
...
func Test_registerHealthStateMetrics_RegistrationError(t *testing.T) {
	...
	_, err := RegisterHealthStateMetricsWithRegistere(registry, componentName)
	require.NoError(t, err)
...
func Test_registerHealthStateMetrics_MultipleComponents(t *testing.T) {
	...
	setter1, err := RegisterHealthStateMetricsWithRegistere(registry, component1)
	require.NoError(t, err)
	require.NotNil(t, setter1)

	component2 := "component2"
	setter2, err := RegisterHealthStateMetricsWithRegistere(registry, component2)
	require.NoError(t, err)
	require.NotNil(t, setter2)

	// Test setters for both components
	setter1.SetHealthy(true)
	setter2.SetUnhealthy(true)
...
func Test_registerHealthStateMetrics_ErrorOnSecondMetric(t *testing.T) {
	...
	_, err := RegisterHealthStateMetricsWithRegistere(customReg, componentName)
	require.Error(t, err)
}

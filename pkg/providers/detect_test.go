...
func TestDetector_Name(t *testing.T) {
	...
	d := New(testProviderName, nil, nil, nil, nil, nil)
...
func TestDetector_Provider(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			d := New(testProviderName, tc.fetchTokenFunc, nil, nil, nil, nil)
...
func TestDetector_PublicIPv4(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Use the New function from the package
			d := New(testProviderName, nil, tc.fetchPublicIPFunc, nil, nil, nil)
...
func TestDetector_VMEnvironment(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Use the New function from the package
			d := New(testProviderName, nil, nil, nil, tc.fetchVMEnvironmentFunc, nil)
...
func TestNew(t *testing.T) {
	...
	d := New(testName, mockTokenFunc, mockIPFunc, nil, mockVMEnvFunc, nil)
	...
	dNilFuncs := New("niltest", nil, nil, nil, nil, nil)

...
func createLoginRequest(
	...
	log.Logger.Infow("detected public IP", "publicIP", req.Network.PublicIP)

	detectedProvider := getProviderFunc(req.Network.PublicIP)
	log.Logger.Infow("provider detection completed",
	...
	log.Logger.Infow("login request provider fields set",

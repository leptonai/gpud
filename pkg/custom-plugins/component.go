...
func (c *component) Check() components.CheckResult {
	...
	defer func() {
		...
		if c.healthStateSetter != nil {
			c.healthStateSetter.SetHealthy(cr.health == apiv1.HealthStateTypeHealthy)
			c.healthStateSetter.SetUnhealthy(cr.health == apiv1.HealthStateTypeUnhealthy)
			c.healthStateSetter.SetDegraded(cr.health == apiv1.HealthStateTypeDegraded)
		}
		c.lastMu.Unlock()
	}()

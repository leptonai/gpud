...
`,
			...
			Flags: []cli.Flag{
				...
				// optional, only required for joining the platform/control plane
				cli.StringFlag{
					Name:  "provider",
					Usage: "(optional) provider of the machine",
				},
				cli.StringFlag{
					Name:  "provider-instance-id",
					Usage: "(optional) provider instance id of the machine",
				},
				cli.StringFlag{
					Name:  "node-group",
				...
				cli.BoolFlag{
					...
					Usage: "(optional) use detected value instead of prompting for user input",
				},
				cli.StringFlag{
					Name:  "extra-info",
					Usage: "(optional) base64 encoded extra info to pass to control plane",
				},
				cli.StringFlag{
					Name:  "region",
					Usage: "(optional) specify the region of the machine",
				},
				cli.StringFlag{
					Name:  "gpu-product",
					Usage: "(optional) specify the GPU shape of the machine",
				},
			},
		},
		{
